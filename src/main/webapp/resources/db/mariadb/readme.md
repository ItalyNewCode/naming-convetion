...
Schema SQL del database MariaDB collegato al progetto.

## Contenuto

- `schema.sql` — script completo di creazione dello schema (tabelle, indici, constraint, view, procedure, trigger)
